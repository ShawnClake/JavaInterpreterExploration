...
public class Parser {
    ...
    private ArrayList<Node> declarations() throws Exception
    {
        ...
        while(this.currentToken.getType() == Token.TokenType.PROCEDURE)
        {
            this.eat(Token.TokenType.PROCEDURE);
            String procedureName = this.currentToken.getValue().getString();
            this.eat(Token.TokenType.ID);
            this.eat(Token.TokenType.SEMI);
            BlockNode bNode = (BlockNode)this.block();
            ProcedureDeclarationNode procedureDeclarationNode = new ProcedureDeclarationNode(procedureName, bNode);
            declarations.add(procedureDeclarationNode);
            this.eat(Token.TokenType.SEMI);
        }
